...
#Revisamos si esta dentro de rengo
#esta_dentro_rango = 1 <= dato <= 10
#print(f"Variable esta dentro del rango (entre 1 y 10)? {esta_dentro_rango}")

# Revisamos la logica inversa, si el dato esta fuera de rango
esta_fuera_rango = not(1 <= dato <= 10)
print(f"Variable fuera de rango? {esta_fuera_rango}")